...
const Navbar = () => {
  ...
  <div className="absolute top-0 left-0 w-full z-10 ">
    <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20  lg:px-32 bg-transparent'>
        ...
        <button className='hidden md:block bg-white px-8 py-2 rounded-full cursor-pointer hover:bg-blue-400 hover:text-white transition duration-400 ease-in-out'> Sign Up</button>
